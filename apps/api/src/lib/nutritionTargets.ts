/** Mifflin–St Jeor + activity + goal delta; protein range (g/day). Keep in sync with apps/web/lib/nutritionTargets.ts */
...
/** Protein g per kg body weight (low, high) by goal. */
